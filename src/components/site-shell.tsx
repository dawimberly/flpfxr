    ...
    <section className="bg-cream px-4 py-16 text-cream-fg md:py-20">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link
            to="/contact"
            className="inline-flex h-12 items-center justify-center rounded-lg border border-cream-fg/20 px-6 text-sm font-semibold text-cream-fg hover:bg-cream-fg/5"
          >
            Send pictures
          </Link>
        </div>
