...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Call (210) 436-9117. Roof jobs start on the roof page. Kitchens start on the kitchen page. Pictures help. We'll walk the job if we need to and give you a number.",
  },
  {
